									...
									<div className='grid grid-cols-2 gap-4'>
										...
										<div className='my-10'>
												...
												{isEditing === 'person1' ? (
													...
													<p className='text-end flex items-center justify-end'>
														...
														<span className='text-lg ml-2 inline-flex items-center'>
															<CiEdit
																onClick={() => handleEditClick('person1')}
															/>
														</span>
													</p>
												)}
											...
											<div className='bg-[#202020] grid grid-cols-2   px-10 pt-5'>
												...
												<div className='text-end'>
													...
													>
														...
														{years
															.filter(
																year => currentYear - parseInt(year.value) > 18
															)
															.map(year => (
											...
											<div className='bg-[#202020] grid grid-cols-2 px-10 pt-5'>
												...
												>
													<option value=''>Please Select</option>
													<option value='Not your business'>
														Not your business{' '}
													</option>
													<option value='Like a cactus'> Like a cactus</option>
													<option value='I drink if offered'>
														I drink if offered
													</option>
											...
											<div className='bg-[#202020] grid grid-cols-2 px-10 pt-5'>
												<span>Language</span>
												<input
													className='max-w-[450px] border-2 border-orange rounded-[5px] h-[40px] text-black px-5 font-light ml-auto'
													type='text'
											...
											<div className='text-end flex items-center justify-end pb-0'>
												{isEditing === 'person2' ? (
													...
													<p className='text-end flex items-center justify-end'>
														...
														<span className='text-lg ml-2 inline-flex items-center'>
															<CiEdit
																onClick={() => handleEditClick('person2')}
															/>
														</span>
													</p>
												)}
